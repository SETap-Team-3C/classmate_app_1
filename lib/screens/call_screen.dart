...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _toggleCall() async {
    ...
    if (_isCalling) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(loc.t('call_ended'))));
      return;
    }

    final phone = widget.userPhone?.trim() ?? '';
    if (phone.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(loc.t('no_phone_number_found'))));
      return;
    }
    ...
    if (launched) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(loc.t('opening_dialer_for', params: {'phone': phone}))));
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(loc.t('could_not_open_dialer'))));
    }
  }
