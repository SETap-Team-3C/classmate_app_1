...
import 'package:classmate_app_1/core/theme/theme_provider.dart';import 'package:firebase_auth_mocks/firebase_auth_mocks.dart';
...
final auth = MockFirebaseAuth(
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: HomeScreen(
          title: 'Classmate Home',          auth: auth,
